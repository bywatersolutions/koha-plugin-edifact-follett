package Koha::Plugin::Com::ByWaterSolutions::EdifactFollett;
...
our $metadata = {
    name            => 'Edifact - Follett',
    author          => 'Kyle M Hall',
    description     => 'Edifact plugin for Follett',
...
sub edifact {
    ...
    require Koha::Plugin::Com::ByWaterSolutions::EdifactFollett::Edifact;

    my $edifact = Koha::Plugin::Com::ByWaterSolutions::EdifactFollett::Edifact->new($args);
    return $edifact;
}
...
sub edifact_order {
    ...
    require Koha::Plugin::Com::ByWaterSolutions::EdifactFollett::Edifact::Order;

    $args->{params}->{plugin} = $self;
    my $edifact_order = Koha::Plugin::Com::ByWaterSolutions::EdifactFollett::Edifact::Order->new( $args->{params} );
...
sub edifact_transport {
    ...
    require Koha::Plugin::Com::ByWaterSolutions::EdifactFollett::Edifact::Transport;

    $args->{params}->{plugin} = $self;

    my $edifact_transport = Koha::Plugin::Com::ByWaterSolutions::EdifactFollett::Edifact::Transport->new( $args->{vendor_edi_account_id}, $self );
